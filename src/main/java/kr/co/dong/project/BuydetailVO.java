...
public class BuydetailVO {
	...
	public String toString() {
		return "BuydetailVO [buydetail_no=" + buydetail_no + ", buydetail_buyno=" + buydetail_buyno
				...
				+ ", buydetail_del=" + buydetail_del + ", buy_userid=" + buy_userid + ", buy_regdate=" + buy_regdate
				+ ", buy_address=" + buy_address + ", buy_receive=" + buy_receive + ", product_price=" + product_price
				+ ", product_name=" + product_name + ", user_name=" + user_name + ", user_phone=" + user_phone
				+ ", user_email=" + user_email + ", grade_discount=" + grade_discount + ", buycancel_buydetailno="
				+ buycancel_buydetailno + ", buycancel_regdate=" + buycancel_regdate + "]";
	}
